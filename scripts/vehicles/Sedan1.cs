...
namespace Crosswalk
{
    ...
    public partial class Sedan1 : Car
    {
        ...
        [Export] public override float Speed { get; set; } = 350.0f;
        [Export] public override float BrakingForce { get; set; } = 1120.0f;
        [Export] public override float AccelerationForce { get; set; } = 260.0f;
