...
namespace Crosswalk
{
    ...
    /// </summary>
    public partial class Beetle1 : Car
    {
        #region Public Properties

        [Export] public override float _speed { get; set; } = 310.0f;
        [Export] public override float _brakingForce { get; set; } = 950.0f;
        [Export] public override float _accelerationForce { get; set; } = 230.0f;
