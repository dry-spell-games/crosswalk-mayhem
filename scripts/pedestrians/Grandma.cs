...
{
    /// <summary>
    /// Grandma is a subclass of abstract class Pedestrian. It uses mostly base methods,
    ...
    public partial class Grandma : Pedestrian
    {
        ...
        /// <summary>
        /// Starts and manages grandma's random stop behavior.
        /// She occasionally stops walking if certain conditions are met.
        /// </summary>
        ...
        /// <summary>
        /// Executes behavior when grandma is hit by a car.
